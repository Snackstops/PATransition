...
@interface PATransitionProperty : NSObject
...
/**
 *  返回上个界面的手势 默认：右滑 ：PAGestureTypePanRight
 *  choose type of gesture for back , default : PAGestureTypePanRight
 */
